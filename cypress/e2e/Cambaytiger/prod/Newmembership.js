...
describe('Membership functionality', () => {
  ...
  it('Bronze Membership functionality', () => {
    ...
    const query = `
          mutation {
            createMembership(input: {userId: "92830", tier: TIER_1}) {
              success
            }
          }
        `;
        ...
        cy.request({
          method: 'POST',
          url: 'https://cambaytigerhapi.farziengineer.co/graphql/?source=website', // Replace with your API endpoint
          body: {
            query,
          },
          headers,
  ...
  it('Gold Membership functionality', () => {
    ...
    const query = `
          mutation {
            createMembership(input: {userId: "92830", tier: TIER_3}) {
              success
            }
          }
        `;
  ...
  it('Silver Membership functionality', () => {
    ...
    const query = `
          mutation {
            createMembership(input: {userId: "92830", tier: TIER_2}) {
              success
            }
          }
        `;
