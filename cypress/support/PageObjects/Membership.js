...
// }
  ...
  orderPlace() {
    ...
    cy.get("div[class='showOnDesktop'] div[class='scss_appContainer__yvhBB'] div[class='product-page'] main[class='sc-NGAnU gEHTKD'] div[class=' product-container '] div[class='product-page__product__info'] div[class='showOnDesktop'] div[class='product-page__product__info--fixed'] div[class='sc-iCwjlJ isDHAo'] div[class='sc-fkyLDJ hTKHCQ'] section[class='sc-bbkauy bVlfoz'] div[class='add-to-cart-btn sc-iIHSe gaUIrK'] div p[class='font-weight:900; font-size:20px']").click();
    cy.contains("Cart").eq(0).click();
  ...
  orderPlaceProd() {
    cy.visit("https://cambaytiger.com/product/chingri-malai-curry/chingri-malai-curry");
    cy.get("div[class='showOnDesktop'] div[class='showOnDesktop'] div[class='undefined__mainText sc-gzOgki fSlvAH']").click();
    cy.contains("Cart").eq(0).click();
  ...
  removeMembership() {
    ...
    const expireMembershipQuery = `
      mutation {
        expireMembership(input: {userId: "92294"}) {
          success
        }
      }
    `;
  ...
  removeMembershipProd() {
    ...
    const expireMembershipQuery = `
    mutation {
      expireMembership(input: {userId: "92830"}) {
        success
      }
    }
  `;
